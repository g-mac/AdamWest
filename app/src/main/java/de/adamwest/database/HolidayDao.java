...
public class HolidayDao extends AbstractDao<Holiday, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property CurrentRouteId = new Property(4, Long.class, "currentRouteId", false, "CURRENT_ROUTE_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'HOLIDAY' (" + //
                ...
                "'CURRENT_ROUTE_ID' INTEGER);"); // 4: currentRouteId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Holiday entity) {
        ...
        Long currentRouteId = entity.getCurrentRouteId();
        if (currentRouteId != null) {
            stmt.bindLong(5, currentRouteId);
        }
    }
    ...
    public Holiday readEntity(Cursor cursor, int offset) {
        Holiday entity = new Holiday( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4) // currentRouteId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Holiday entity, int offset) {
        ...
        entity.setCurrentRouteId(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN ROUTE T0 ON T.'CURRENT_ROUTE_ID'=T0.'_id'");
            builder.append(' ');
